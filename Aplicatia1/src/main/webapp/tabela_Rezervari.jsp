...
<html> 
    ...
    <body> 
        ...
        <h1 align="center"> Tabela Rezervari</h1> 
             ...
             <p align="center">
		<a href="nou_Rezervare.jsp"><b>Adauga o noua rezervare</b></a>
	</p>
	<p align="center">
		<a href="modifica_Rezervare.jsp"><b>Modifica o rezervare</b></a>
	</p>

        <form action="sterge_Rezervare.jsp" method="post"> 
